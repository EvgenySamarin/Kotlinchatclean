...
class NotificationHelper @Inject constructor(val context: Context) {
    ...
    /**
     * предварительный парс сообщения. Исходя из типа (valtype), делегирует отображение
     * нотификации одному из методов. Принимает Ничего не возвращает
     */
    ...
    /** делегируют парс сообщения функции parseFriend(…) и показывают toast */
