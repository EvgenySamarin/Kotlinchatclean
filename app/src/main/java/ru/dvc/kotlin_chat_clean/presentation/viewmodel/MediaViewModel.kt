...
import ru.dvc.kotlin_chat_clean.domain.media.CreateImageFile
import ru.dvc.kotlin_chat_clean.domain.media.EncodeImageBitmap
import ru.dvc.kotlin_chat_clean.domain.media.GetPickedImage
import ru.dvc.kotlin_chat_clean.domain.type.None
import javax.inject.Inject

/**
 * Модель для взаимодействия с файлами
 *
...
class MediaViewModel @Inject constructor(
    ...
    /** 2019.11.13 v1 выполняет обработку данных для onActivityResult */
